    ...
    <>
      ...
      <Layout>
        <section className={'space-y-5'}>
          <div className={'px-4 lg:px-14 flex justify-between'}>
            <h1 className={'text-lg lg:text-xxl font-medium'}>Liste des publications</h1>
            <Link href={'/publications/creation'} className={'inline-flex items-center gap-2 text-primary'}>
              <div className={'bg-primary p-1 rounded-full'}>
                <RiAddLine className={'w-10 h-10 text-white'}/>
              </div>
